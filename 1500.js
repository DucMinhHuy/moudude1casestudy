let img=["http://t1.gstatic.com/licensed-image?q=tbn:ANd9GcR8gQcD5ewEV7b-FcPzhJ2u6OGX_lChJROgta0c6zyRPPLSe2ES6yKJQvxiQOoyjdhp",
"https://cdn.britannica.com/05/147405-004-8572CF16.jpg",
"http://t0.gstatic.com/licensed-image?q=tbn:ANd9GcRXeXigzN_jYaaGuvF-Q3O-uiyzGOB3tBvTNDzjj8Gz3apO5VUF_W4PlMuGXlNN1lqF",]
...
function show(){
    ...
    for(let i=0;i<sua.length;i++) {
        count += "<tr>" +
            "<td>" + sua[i] + "</td>" +
            "<td><img src='"+img[i]+"' height='60px'></td>"+
