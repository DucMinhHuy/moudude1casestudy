let img=["https://vcdn-vnexpress.vnecdn.net/2017/04/26/6-7047-1493192943.jpg",
"http://t1.gstatic.com/licensed-image?q=tbn:ANd9GcRsWLVF3JTFBj1_hnGNWFngZUmte1C0--rCCaw2jQ9_hvquZWtBMcEvZ2oQU2iqzFNi",
"http://t1.gstatic.com/licensed-image?q=tbn:ANd9GcQEa5vIB5rge7TBnRlfcRE3aenGyBmTuIVJFOxEFkEphZVxcaxDQkImgUzPPsBEAy7N"]
...
function show(){
    ...
    for(let i=0;i<sua.length;i++) {
        count += "<tr>" +
            "<td>" + sua[i] + "</td>" +
            "<td><img src='"+img[i]+"'height='50px'></td>"+
